...
{
    public class EngineGunBehavior : BaseGunBehavior
    {
        [LineSpacer]
        ...
        public override void Initialise(CharacterBehaviour characterBehaviour, WeaponData data)
        {
            ...
            if (upgrade == null)
            {
                Debug.LogError($"[Engine] Upgrade '{data.UpgradeType}' tidak ditemukan! Cek nama Upgrade di Weapons Database.");
                return;
            }
            ...
            if (stage != null && stage.BulletPrefab != null)
            {
                ...
                Debug.Log("[Engine] Pool peluru SIAP!");
            }
            else
            {
                Debug.LogError("[Engine] Bullet Prefab di ScriptableObject Upgrade masih KOSONG!");
            }
