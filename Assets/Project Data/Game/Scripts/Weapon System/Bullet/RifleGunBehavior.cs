...
{
    public class RifleGunBehavior : BaseGunBehavior
    {
        [LineSpacer]
        ...
        public override void Initialise(CharacterBehaviour characterBehaviour, WeaponData data)
        {
            ...
            if (upgrade == null)
            {
                Debug.LogError($"[Rifle] Upgrade '{data.UpgradeType}' tidak ditemukan! Cek nama Upgrade di Weapons Database.");
                return;
            }
            ...
            if (stage != null && stage.BulletPrefab != null)
            {
                ...
                Debug.Log("[Rifle] Pool peluru SIAP!");
            }
            else
            {
                Debug.LogError("[Rifle] Bullet Prefab di ScriptableObject Upgrade masih KOSONG!");
            }
        ...
        private void Shoot()
        {
            ...
            // Ambil stage untuk tau jumlah peluru
